...
export const MovieDetail = () => {
    ...
    useEffect(() => {
        async function fetchMovie() {
            const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=c975973c6c42e5f674af87cea79cfab7`)
            ...
            <section className="flex justify-around flex-wrap py-5">
                ...
                <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className=" text-gray-900 underline  dark:text-white">{movie.vote_count} reviews</span>
                    </div>
